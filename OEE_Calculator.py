...
def get_data():
    ...
    DText = tk.Label(master=DFrame, text="Czas operacyjny", font=("Times", "8"))
    DText.place(x=0, y=0)
    ...
    WText = tk.Label(master=WFrame, text="Czas operacyjny", font=("Times", "8"))
    WText.place(x=0, y=0)
    ...
    JText = tk.Label(master=JFrame, text="Czas operacyjny", font=("Times", "8"))
    JText.place(x=0, y=0)
